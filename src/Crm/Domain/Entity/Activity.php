...
#[ORM\Entity(repositoryClass: 'App\Crm\Infrastructure\Repository\ActivityRepository')]
...
#[\App\Crm\Application\Service\Export\Annotation\Order(['id', 'name', 'project', 'budget', 'timeBudget', 'budgetType', 'color', 'visible', 'comment', 'billable', 'number'])]
#[\App\Crm\Application\Service\Export\Annotation\Expose(name: 'project', label: 'project', exp: 'object.getProject() === null ? null : object.getProject().getName()')]
#[\App\Crm\Application\Service\Validator\Constraints\Activity]
class Activity implements EntityWithMetaFields, EntityWithBudget
{
    ...
    #[Serializer\Type(name: 'array<App\Crm\Domain\Entity\ActivityMeta>')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[\App\Crm\Application\Service\Export\Annotation\Expose(label: 'activity_number')]
