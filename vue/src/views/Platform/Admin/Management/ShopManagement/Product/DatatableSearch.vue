...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        ShopService.deleteProduct(this.editedItem).then(
            (response) => {
                this.products = response.data;
                Object.assign(this.products[this.editedIndex], this.editedItem);this.products.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
      if (this.editedIndex > -1) {
          ShopService.updateProduct(this.editedItem).then(
              (response) => {
          ...
          ShopService.createProduct(this.editedItem).then(
              (response) => {
