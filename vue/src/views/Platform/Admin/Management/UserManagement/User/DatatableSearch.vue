...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        AdminService.deleteUser(this.editedItem).then(
            (response) => {
                this.users = response.data;
                Object.assign(this.users[this.editedIndex], this.editedItem);this.users.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
      if (this.editedIndex > -1) {
          ...
          this.editedItem.password = 'password-test';
          this.editedItem.username = this.editedItem.email;
          AdminService.createUser(this.editedItem).then(
              (response) => {
