...
#[OA\Tag(name: 'Crm Activity Management')]
final class ActivityController extends AbstractController
{
    ...
    public function indexAction(int $page, Request $request, User $loggedInUser, UserRepository $userRepository): JsonResponse|RedirectResponse
    {
        ...
        $query->setCurrentUser($loggedInUser);
        $query->setPage($page);
    ...
    public function createDefaultTeamAction(Activity $activity, TeamRepository $teamRepository, User $loggedUser): Response
    {
        ...
        $defaultTeam->addTeamlead($loggedUser);
    ...
    public function exportAction(Request $request, EntityWithMetaFieldsExporter $exporter, User $loggedUser): Response
    {
        $query = new ActivityQuery();
        $query->setCurrentUser($loggedUser);
