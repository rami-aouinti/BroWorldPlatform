...
use App\Crm\Application\Service\Model\TimesheetStatistic;
...
use App\Crm\Infrastructure\Repository\Loader\TimesheetLoader;
...
use App\Crm\Infrastructure\Repository\Result\TimesheetResult;
...
class TimesheetRepository extends EntityRepository
{
    ...
    public function findMatchingRates(Timesheet $timesheet): array
    {
        ...
        return array_merge($results, $qb->getQuery()->getResult());
    }
    ...
    private function getQueryBuilderForQuery(TimesheetQuery $query): QueryBuilder
    {
        ...
        if (count($user) === 0 && null !== ($currentUser) && !$currentUser->canSeeAllData()) {
