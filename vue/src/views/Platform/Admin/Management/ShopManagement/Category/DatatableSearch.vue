...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        ShopService.deleteCategory(this.editedItem).then(
            (response) => {
                this.categories = response.data;
                Object.assign(this.categories[this.editedIndex], this.editedItem);this.categories.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
      if (this.editedIndex > -1) {
          ShopService.updateCategory(this.editedItem).then(
              (response) => {
          ...
          ShopService.createCategory(this.editedItem).then(
              (response) => {
  ...
  computed: {
    ...
    mounted() {
        ShopService.getCategories().then(
            (response) => {
                this.categories = response.data;
            },
            (error) => {
