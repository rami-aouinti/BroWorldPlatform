...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        AdminService.deleteUserRole(this.editedItem).then(
            (response) => {
                this.usersRoles = response.data;
                Object.assign(this.usersRoles[this.editedIndex], this.editedItem);this.usersRoles.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
        if (this.editedIndex > -1) {
            AdminService.updateUserGroup(this.editedItem).then(
                (response) => {
                    Object.assign(this.usersRoles[this.editedIndex], this.editedItem);
                    this.close();
                },
                (error) => {
                    this.content =
            ...
            AdminService.createUserRole(this.editedItem).then(
                (response) => {
                    this.usersRoles.push(this.editedItem);
                    this.close();
                },
                (error) => {
                    this.content =
