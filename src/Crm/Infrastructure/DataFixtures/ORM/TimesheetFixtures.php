...
{
    public const int MIN_TIMESHEETS_PER_USER = 100;
    public const int MAX_TIMESHEETS_PER_USER = 1000;
    public const int MAX_TIMESHEETS_TOTAL = 10000;
    public const int MIN_MINUTES_PER_ENTRY = 15;
    public const int MAX_MINUTES_PER_ENTRY = 840; // 14h
    public const int MAX_DESCRIPTION_LENGTH = 200;

    public const int ADD_TAGS_MAX_ENTRIES = 1000;
    public const int MAX_TAG_PER_ENTRY = 3;
