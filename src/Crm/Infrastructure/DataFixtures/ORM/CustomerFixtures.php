...
{
    public const int MIN_CUSTOMERS = 5;
    public const int MAX_CUSTOMERS = 15;
    public const int MIN_BUDGET = 0;
    public const int MAX_BUDGET = 100000;
    public const int MIN_TIME_BUDGET = 0;
    public const int MAX_TIME_BUDGET = 10000000;
    public const int MIN_GLOBAL_ACTIVITIES = 5;
    public const int MAX_GLOBAL_ACTIVITIES = 30;
    public const int MIN_PROJECTS_PER_CUSTOMER = 2;
    public const int MAX_PROJECTS_PER_CUSTOMER = 25;
    public const int MIN_ACTIVITIES_PER_PROJECT = 0;
    public const int MAX_ACTIVITIES_PER_PROJECT = 25;
    ...
    private function createProject(Generator $faker, Customer $customer, bool $visible): Project
    {
        ...
        $entry->setVisible($visible);
        $entry->setOrderDate(new DateTime('now'));
        $entry->setStart(new DateTime('now'));
        $entry->setEnd(new DateTime('now'));
