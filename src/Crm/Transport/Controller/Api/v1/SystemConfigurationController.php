...
use App\Crm\Application\Service\Configuration\ConfigurationService;
...
use App\Crm\Application\Service\Validator\Constraints\ColorChoices;
use App\Crm\Application\Service\Validator\Constraints\DateTimeFormat;
use App\Crm\Application\Service\Validator\Constraints\TimeFormat;
use App\Crm\Transport\Event\SystemConfigurationEvent;
use App\Crm\Transport\Form\Model\Configuration;
use App\Crm\Transport\Form\Model\SystemConfiguration as SystemConfigurationModel;
use App\Crm\Transport\Form\SystemConfigurationForm;
use App\Crm\Transport\Form\Type\ActivityTypePatternType;
use App\Crm\Transport\Form\Type\ArrayToCommaStringType;
use App\Crm\Transport\Form\Type\CalendarTitlePatternType;
use App\Crm\Transport\Form\Type\CustomerTypePatternType;
use App\Crm\Transport\Form\Type\DatePickerType;
use App\Crm\Transport\Form\Type\DateTimeTextType;
use App\Crm\Transport\Form\Type\DayTimeType;
use App\Crm\Transport\Form\Type\MinuteIncrementType;
use App\Crm\Transport\Form\Type\ProjectTypePatternType;
use App\Crm\Transport\Form\Type\RoundingModeType;
use App\Crm\Transport\Form\Type\SkinType;
use App\Crm\Transport\Form\Type\TimezoneType;
use App\Crm\Transport\Form\Type\TrackingModeType;
...
#[OA\Tag(name: 'Crm System Configuration Management')]
final class SystemConfigurationController extends AbstractController
{
    public function __construct(
        private EventDispatcherInterface $eventDispatcher,
        private ConfigurationService $repository,
     ...
     */
    #[Route(path: '/update/{section}/{single}', defaults: [
        'single' => 0,
    ], name: 'system_configuration_update', methods: ['POST'])]
