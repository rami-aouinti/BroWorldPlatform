...
use App\Crm\Transport\Form\Type\BillableSearchType;
use App\Crm\Transport\Form\Type\CustomerType;
use App\Crm\Transport\Form\Type\DateRangeType;
use App\Crm\Transport\Form\Type\PageSizeType;
use App\Crm\Transport\Form\Type\ProjectType;
use App\Crm\Transport\Form\Type\SearchTermType;
use App\Crm\Transport\Form\Type\TagsType;
use App\Crm\Transport\Form\Type\TeamType;
use App\Crm\Transport\Form\Type\UserType;
use App\Crm\Transport\Form\Type\VisibilityType;
use Exception;
            ...
            function (FormEvent $event) use ($builder, $options, $name, $multiCustomer, $multiProject, $multiActivity) {
                ...
                $event->getForm()->add($name, ProjectType::class, array_merge([
                    ...
                    'query_builder' => function (ProjectRepository $repo) use ($builder, $data, $options, $multiCustomer, $multiProject) {
                        ...
                        if (isset($options['ignore_date']) && $options['ignore_date'] === true) {
