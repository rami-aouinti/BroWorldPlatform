  ...
  <div>
    <v-card class="card-shadow border-radius-xl">
      ...
      <v-card-text class="px-0 py-0">
        <v-data-table
          :headers="headers"
          v-if="menuManagement && menuManagement.length"
...
export default {
  ...
  methods: {
    editItem(item) {
      this.editedIndex = this.menuManagement.indexOf(item);
    ...
    deleteItemConfirm() {
      this.menuManagement.splice(this.editedIndex, 1);
      this.closeDelete();
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        Object.assign(this.menuManagement[this.editedIndex], this.editedItem);
      } else {
        this.menuManagement.push(this.editedItem);
      }
      this.close();
    },
  },
  ...
  computed: {
      ...mapGetters('menuManagement', ['menuManagement']),
    formTitle() {
