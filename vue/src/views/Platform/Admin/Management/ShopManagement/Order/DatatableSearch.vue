...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        ShopService.deleteOrder(this.editedItem).then(
            (response) => {
                this.orders = response.data;
                Object.assign(this.orders[this.editedIndex], this.editedItem);this.orders.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
      if (this.editedIndex > -1) {
          ShopService.updateOrder(this.editedItem).then(
              (response) => {
          ...
          ShopService.createOrder(this.editedItem).then(
              (response) => {
