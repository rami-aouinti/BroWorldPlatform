...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
        AdminService.deleteUserGroup(this.editedItem).then(
            (response) => {
                this.usersGroups = response.data;
                Object.assign(this.usersGroups[this.editedIndex], this.editedItem);this.usersGroups.splice(this.editedIndex, 1);
                this.closeDelete();
    ...
    save() {
        this.editedItem.role = this.selectedRoles;
        console.log(this.editedItem);
        if (this.editedIndex > -1) {
            AdminService.updateUserGroup(this.editedItem).then(
                (response) => {
                    Object.assign(this.usersGroups[this.editedIndex], this.editedItem);
                    this.close();
                },
                (error) => {
                    this.content =
            ...
            AdminService.createUserGroup(this.editedItem).then(
                (response) => {
                    this.usersGroups.push(this.editedItem);
                    this.close();
                },
                (error) => {
                    this.content =
  ...
  computed: {
    ...
    mounted() {
        AdminService.getUsersGroup().then(
            (response) => {
                this.usersGroups = response.data;
            },
            (error) => {
        ...
        AdminService.getUsersRole().then(
            (response) => {
