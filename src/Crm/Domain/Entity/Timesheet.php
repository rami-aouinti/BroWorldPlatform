...
#[ORM\Entity(repositoryClass: 'App\Crm\Infrastructure\Repository\TimesheetRepository')]
...
#[\App\Crm\Application\Service\Validator\Constraints\Timesheet]
#[\App\Crm\Application\Service\Validator\Constraints\TimesheetDeactivated]
class Timesheet implements EntityWithMetaFields, ExportableItem, ModifiedAt
{
    ...
    #[Serializer\Type(name: 'array<App\Crm\Domain\Entity\TimesheetMeta>')]
